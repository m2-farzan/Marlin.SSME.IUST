...
#define STRING_CONFIG_H_AUTHOR "SSME.IUST" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_RAMPS_14_EFB // Correct! RAMPS v1.4 (Extruder, Fan, Bed) !!!!!! OR EEB??? (Currenly EFB)
#endif
...
#define DEFAULT_NOMINAL_FILAMENT_DIA 1.75 // ask ?
 ...
 */
#define TEMP_SENSOR_0 1 // Not verified
 ...
 */
// #define PREVENT_COLD_EXTRUSION // IMPORTANT FIX
 ...
 */
//#define X_DRIVER_TYPE  A4988 // todo: check these out
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 169.764875647 * 1.00/1.05, 169.764875647 * 1.00/1.05, 800, 191.044776119 } // 200/8, 200/8, 200/8 // Extruder: 33.5 mm per rev, 32 microstep, 200 step per rev
